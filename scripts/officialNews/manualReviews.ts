...
export const MANUAL_EVENT_REVIEWS: Record<string, ManualReview> = {
  ...
  "00873e2d-bb0b-4d07-ba73-827a64ba7d13": replace("会場は主催者が都内某所としているが、日付確定の招待イベント", [
    ...dated("映画『モアナと伝説の海』吹替版試写会", "都内某所", ["2026-07-29"]),
  ]),
  ...
  "9590aa79-540a-4ffe-b699-0ad8ecce7614": replace("オンラインだがアーティスト関連イベントとして登録", [
    ...dated("42ndシングル『是非に及ばず』発売記念オンラインミート＆グリート", "オンライン", ["2026-08-16", "2026-09-13", "2026-09-27", "2026-10-18", "2026-10-24", "2026-11-15"]),
  ]),
