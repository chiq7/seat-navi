...
export const MANUAL_EVENT_REVIEWS: Record<string, ManualReview> = {
  ...
  "f2b91648-9c6a-4ce8-8f90-19ffb2476530": ignore("VR映画館上映はNEWSとして保持し、将来の専用ページまで公演一覧へ反映しない"),
  ...
  "e876ee3b-633c-42ab-85e1-8522290a75b6": ignore("展示はNEWSとして保持し、将来の専用ページまで公演一覧へ反映しない"),
};
