  ...
  return (
    <StaticPage title="プライバシーポリシー">
      <div className="space-y-5">
        ...
        <section>
          <h2 className="text-[15px] font-bold text-gray-900">1. 取得する可能性がある情報</h2>
