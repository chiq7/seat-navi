...
export default function MapPreviewSection({ mapEvent }: Props) {
  ...
  return (
    <div className="border border-divider bg-white">
      <div className="flex items-end justify-between gap-3 border-b border-divider px-4 py-4 sm:px-6">
        <div>
      ...
      <SeatMapColorTabs value={colorMode} onChange={setColorMode} className="border-x-0 border-t-0 border-b-divider" />
      ...
      <Link
        ...
        className="zr-focus group flex min-h-14 w-full items-center justify-between gap-3 border-t border-divider bg-[#f43679] px-5 text-[13px] font-black text-white sm:px-6"
      >
