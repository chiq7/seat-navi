    ...
    <header className="relative z-50 border-b border-[#f3e3e9] bg-white/95 backdrop-blur">
      <div className="zr-container flex h-[64px] items-center gap-4 md:h-[74px]">
        ...
        <div className="ml-auto flex items-center gap-2">
          <Link href="/search" aria-label="検索" className="zr-focus flex h-10 items-center gap-2 rounded-full bg-[#fff2f6] px-3 text-[12px] font-bold text-[#6b5b64] transition hover:bg-[#ffe1ec] sm:px-5">
            <Search size={17} />
